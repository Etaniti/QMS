...
namespace App\Http\Requests\EmployeeSpecialists;
...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'employee_photo' => ['nullable', 'image', 'mimes:jpeg,png,jpg', 'max: 3999'],
            'employee_birth_date' => ['required', 'date'],
            'employee_gender' => ['required', 'string'],
            'employee_institution' => ['required', 'string', 'max:255'],
            'employee_graduation_date' => ['required', 'date'],
            'employee_specialization' => ['required', 'string', 'max:255'],
