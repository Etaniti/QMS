...
<div class="container">
    <form action="/staff/specialists/{{ $specialist->id }}" enctype="multipart/form-data" method="post">
        @csrf
        @method('PATCH')
            ...
            <div class="col-10 offset-2">
                ...
                <div class="col-6 offset-2">
                    <div class="form-group row pt-4">
                        <input type="text" name="organization_id" value="{{$specialist->organization_id}}" hidden />
                    ...
                    <div class="form-group row pt-4">
                        ...
                        value="{{ $specialist->specialist_count }}"
                    ...
                    <div class="form-group row pt-4">
                        ...
                        value="{{ $specialist->specialist_tariff_category }}"
                    ...
                    <div class="form-group row pt-4">
                        ...
                        value="{{ $specialist->specialist_tariff_coefficient }}"
                    ...
                    <div class="form-group row pt-4">
                        ...
                        value="{{ $specialist->specialist_tariff_rate }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                ...
                                value="{{ $specialist->specialist_payrise_management_perc }}"
                            ...
                            <div class="mx-3">
                                ...
                                value="{{ $specialist->specialist_payrise_management_amount }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                ...
                                value="{{ $specialist->specialist_payrise_intensity_perc }}"
                            ...
                            <div class="mx-3">
                                ...
                                value="{{ $specialist->specialist_payrise_intensity_amount }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                ...
                                value="{{ $specialist->specialist_payrise_category_perc }}"
                            ...
                            <div class="mx-3">
                                ...
                                value="{{ $specialist->specialist_payrise_category_amount }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                ...
                                value="{{ $specialist->specialist_payrise_specificity_perc }}"
                            ...
                            <div class="mx-3">
                                ...
                                value="{{ $specialist->specialist_payrise_specificity_amount }}"
                    ...
                    <div class="form-group mt-4">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                ...
                                value="{{ $specialist->specialist_additional_stimulation_perc }}"
                            ...
                            <div class="mx-3">
                                ...
                                value="{{ $specialist->specialist_additional_stimulation_amount }}"
