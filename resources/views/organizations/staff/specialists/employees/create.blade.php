...
@section('content')
<div class="container">
    <form action="/specialists/{{ $specialist_id }}/employees" enctype="multipart/form-data" method="post">
        @csrf
            ...
            <div class="col-5 offset-3 mt-4">
                ...
                <div class="card px-4 pb-4">
                    <div class="card-body px-4">
                        <div class="form-group row">
                            <input type="text" name="specialist_id" value="{{$specialist_id}}" hidden />
                        ...
                        <div class="form-group row pt-4">
                            ...
                            <label for="employee_birth_date" class="col-md-6 col-form-label fw-bold datepicker table">Дата рождения</label>
                        ...
                        <div class="form-group flex-column pt-4">
                            ...
                            <div class="flex-row justify-content-between">
                                <input id="employee_gender_2" type="radio" class="align-middle" value="female" name="employee_gender" checked>
                                <label for="employee_gender" class="form-label me-5">Женский</label>

                                <input id="employee_gender_1" type="radio" class="align-middle" value="male" name="employee_gender">
                ...
                <div class="card px-4 pb-4 mt-5">
                    <div class="card-body px-4">
                        ...
                        <div class="form-group row pt-3">
                            ...
                            value="{{ old('employee_institution') }}"
                        ...
                        <div class="form-group row pt-4">
                            ...
                            value="{{ old('employee_specialization') }}">
                ...
                <div class="card px-4 pb-4 mt-5">
                    <div class="card-body px-4">
                        ...
                        <div class="form-group row pt-4">
                            <div class="flex-row justify-content-between">
                                <input id="employee_family_status_1" type="radio" class="align-middle"
                                name="employee_family_status" value="single"
                                onclick="hideInput_1();" checked>
                                <label for="employee_family_status" class="form-label me-5">Холост</label>

                                <input id="employee_family_status_2" type="radio" class="align-middle"
                                name="employee_family_status" value="married"
                                onclick="showInput_1();">
                ...
                <div class="row mt-4 mb-5 px-2 col-md-13">
                    <button class="p-3 mt-3 btn btn-primary d-inline-block">Добавить сотрудника</button>
                </div>
            </div>
        </div>
    </form>
