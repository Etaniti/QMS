...
<div class="container">
    <form action="/staff/workers/{{ $worker->id }}" enctype="multipart/form-data" method="post">
        @csrf
        @method('PATCH')
        ...
        <div class="row">
            <div class="col-10 offset-2">
                ...
                <div class="row pt-4 offset-1">
                    <h2>Редактирование рабочей специальности</h2>
                </div>

                <div class="col-6 offset-2">
                    <div class="form-group row pt-4">
                        <input type="text" name="organization_id" value="{{$worker->organization_id}}" hidden />
                    ...
                    <div class="form-group row pt-4">
                        ...
                        value="{{ $worker->worker_tariff_category }}"
                    ...
                    <div class="form-group row pt-4">
                        ...
                        value="{{ $worker->worker_tariff_coefficient }}"
                    ...
                    <div class="form-group row pt-4">
                        ...
                        value="{{ $worker->worker_tariff_rate }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                ...
                                value="{{ $worker->worker_payrise_management_perc }}"
                            ...
                            <div class="mx-3">
                                ...
                                value="{{ $worker->worker_payrise_management_amount }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                ...
                                value="{{ $worker->worker_payrise_intensity_perc }}"
                            ...
                            <div class="mx-3">
                                ...
                                value="{{ $worker->worker_payrise_intensity_amount }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                ...
                                value="{{ $worker->worker_payrise_category_perc }}"
                            ...
                            <div class="mx-3">
                                ...
                                value="{{ $worker->worker_payrise_category_amount }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                ...
                                value="{{ $worker->worker_payrise_specificity_perc }}"
                            ...
                            <div class="mx-3">
                                ...
                                value="{{ $worker->worker_payrise_specificity_amount }}"
                    ...
                    <div class="form-group mt-4">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                ...
                                value="{{ $worker->worker_additional_stimulation_perc }}"
                            ...
                            <div class="mx-3">
                                ...
                                value="{{ $worker->worker_additional_stimulation_amount }}"
