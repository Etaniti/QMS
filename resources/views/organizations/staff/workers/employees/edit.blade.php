...
@section('content')
<div class="container">
    <form action="/workers/employees/{{ $employeeWorker->id }}" enctype="multipart/form-data" method="post">
        @csrf
        @method('PATCH')
                ...
                <div class="card px-4 pb-4">
                    <div class="card-body px-4">
                        <div class="form-group row">
                            <input type="text" name="worker_id" value="{{ $employeeWorker->worker_id }}" hidden />
                            ...
                            value="{{ $employeeWorker->employee_surname }}"
                        ...
                        <div class="form-group row pt-3">
                            ...
                            name="employee_name"
                            value="{{ $employeeWorker->employee_name }}"
                        ...
                        <div class="form-group row pt-3">
                            ...
                            value="{{ $employeeWorker->employee_patronymic }}"
                        ...
                        <div class="form-group row pt-3">
                            ...
                            name="employee_photo"
                            value="{{ $employeeWorker->employee_photo }}">
                        ...
                        <div class="form-group row pt-4">
                            ...
                            value="{{ $employeeWorker->employee_birth_date }}">
                        ...
                        <div class="form-group flex-column pt-4">
                            ...
                            <div class="flex-row justify-content-between">
                                <input id="employee_gender_2" type="radio" class="align-middle"
                                value="woman" {{ $employeeWorker->employee_gender == "woman" ? 'checked' : '' }} name="employee_gender">
                                <label for="employee_gender" class="form-label me-5">Женский</label>

                                <input id="employee_gender_1" type="radio" class="align-middle"
                                value="man" {{ $employeeWorker->employee_gender == "man" ? 'checked' : '' }} name="employee_gender">
                ...
                <div class="card px-4 pb-4 mt-5">
                    <div class="card-body px-4">
                        ...
                        <div class="form-group row pt-3">
                            ...
                            value="{{ $employeeWorker->employee_institution }}"
                        ...
                        <div class="form-group row pt-3">
                            ...
                            value="{{ $employeeWorker->employee_graduation_date }}">
                        ...
                        <div class="form-group row pt-4">
                            ...
                            value="{{ $employeeWorker->employee_specialization }}">
                    ...
                    <div class="card-body px-4">
                        ...
                        <div class="form-group row pt-4">
                            <div class="flex-row justify-content-between">
                                ...
                                value="single" {{ $employeeWorker->employee_family_status == "single" ? 'checked' : '' }}>
                                <label for="employee_family_status" class="form-label me-5">Холост</label>

                                <input type="radio" class="align-middle"
                                name="employee_family_status" onclick="showInput_1();"
                                value="married" {{ $employeeWorker->employee_family_status == "married" ? 'checked' : '' }}>
                                <label for="employee_family_status"
                                class="form-label">Женат / замужем</label>
                            </div>
                        </div>

                        @if ($employeeWorker->employee_family_structure_name_1 !== null)
                            <div id="family_structure_1" class="form-group row pt-3">
                                ...
                                <div class="card border-secondary p-4">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_name_1 }}">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_date_1 }}">
                        ...
                        @if ($employeeWorker->employee_family_structure_name_2 !== null)
                            <div id="family_structure_2" class="form-group row pt-3">
                                <div class="card border-secondary p-4">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_name_2 }}">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_date_2 }}">
                        ...
                        @if ($employeeWorker->employee_family_structure_name_3 !== null)
                            <div id="family_structure_3" class="form-group row pt-3">
                                <div class="card border-secondary p-4">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_name_3 }}">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_date_3 }}">
                        ...
                        @if ($employeeWorker->employee_family_structure_name_4 !== null)
                            <div id="family_structure_4" class="form-group row pt-3">
                                <div class="card border-secondary p-4">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_name_4 }}">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_date_4 }}">
                        ...
                        @if ($employeeWorker->employee_family_structure_name_5 !== null)
                            <div id="family_structure_5" class="form-group row pt-3">
                                <div class="card border-secondary p-4">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_name_5 }}">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_date_5 }}">
                        ...
                        @if ($employeeWorker->employee_family_structure_name_6 !== null)
                            <div id="family_structure_6" class="form-group row pt-3">
                                <div class="card border-secondary p-4">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_name_6 }}">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_date_6 }}">
                        ...
                        @if ($employeeWorker->employee_family_structure_name_7 !== null)
                            <div id="family_structure_7" class="form-group row pt-3">
                                <div class="card border-secondary p-4">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_name_7 }}">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_date_7 }}">
                        ...
                        @if ($employeeWorker->employee_family_structure_name_8 !== null)
                            <div id="family_structure_8" class="form-group row pt-3">
                                <div class="card border-secondary p-4">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_name_8 }}">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_date_8 }}">
                        ...
                        @if ($employeeWorker->employee_family_structure_name_9 !== null)
                            <div id="family_structure_9" class="form-group row pt-3">
                                <div class="card border-secondary p-4">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_name_9 }}">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_date_9 }}">
                        ...
                        @if ($employeeWorker->employee_family_structure_name_10 !== null)
                            <div id="family_structure_10" class="form-group row pt-3">
                                <div class="card border-secondary p-4">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_name_10 }}">
                                    ...
                                    value="{{ $employeeWorker->employee_family_structure_date_10 }}">
                    ...
                    <div class="card-body px-4">
                        ...
                        <div class="d-flex flex-row justify-content-between">
                            <div class="form-group row col-md-4 pt-3 mr-2">
                                ...
                                value="{{ $employeeWorker->employee_passport_series }}">
                            ...
                            <div class="form-group row col-md-7 pt-3 ml-3">
                                ...
                                value="{{ $employeeWorker->employee_passport_number }}">
                        ...
                        <div class="form-group row pt-3 ml-3">
                            ...
                            value="{{ $employeeWorker->employee_passport_issuance }}">
                        ...
                        <div class="form-group row pt-3 ml-3">
                            ...
                            value="{{ $employeeWorker->employee_passport_issuance_date }}">
                        ...
                        <div class="form-group row pt-3 ml-3">
                            ...
                            value="{{ $employeeWorker->employee_passport_issuance_term }}">
                ...
                <div class="card px-4 pb-4 mt-5">
                    <div class="card-body px-4">
                        ...
                        <div class="form-group row pt-3">
                            ...
                            value="{{ $employeeWorker->employee_living_place }}">
                        ...
                        <div class="form-group row pt-3">
                            ...
                            value="{{ $employeeWorker->employee_residence_place }}">
                ...
                <div class="card px-4 pb-4 mt-5">
                    <div class="card-body px-4">
                        <div class="form-group row pt-3">
                            ...
                            value="{{ $employeeWorker->employee_hiring_date }}">
