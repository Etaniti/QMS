...
class CreateEmployeeSpecialistsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employee_specialists', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('employee_institution');
            $table->date('employee_graduation_date');
            $table->string('employee_specialization');
    ...
    {
        Schema::dropIfExists('employee_specialists');
    }
}
